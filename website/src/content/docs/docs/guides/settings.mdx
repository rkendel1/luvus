...
| Tab | What's there |
|---|---|
| **General** | **Open files with** (read-only or an editor you have installed) and **File click behavior** (**Preview**, the default, or **Open in tab**), see [Browsing & Opening Files](/docs/guides/files/), then a **Notify** section: **sound on done** and **sound on blocked**, both off by default, plus a **Test sound** row to hear it first |
